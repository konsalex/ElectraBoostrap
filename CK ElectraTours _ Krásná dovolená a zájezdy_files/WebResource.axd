...
// Vrací konkrétní století, do kterého patøí rok zadaný pouze dvìma znaky.
// V první fázi se zkonstruuje datum dd.mm.20rr. Otestuje se, zda je datum v budoucnosti. Poukud ano, vrátí se hodnota dd.mm.19rr. Pokud je v minuosti,
// vrátí se hodnota dd.mm.20rr
// napøíklad uživatel vloží 1.1.99. Datum 1.1.2099 je v budoucnosti, vrátí se tedy 1.1.1999
// uživatel vloží 1.1.11. Datum 1.1.2011 je v minulosti, vrátí se tedy 1.1.2011.
function VratStoleti(value, vzdy2000) {
    ...
    // otestujeme, jestli jsme v budoucnosti (v závislosti na mìsíci a dnu)
